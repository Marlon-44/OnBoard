...
const TIPOS_TRANSMISION_PERMITIDOS = ["Automatic", "Manual", "Semi-automatic"];
...
const VehicleFilterForm = () => {
  ...
  const handleApply = async () => {
    try {
      const response = await fetch(`${API_ROOT}/vehiculos/filtrar`, {
        method: "POST",
        headers: {
  ...
  return (
    <aside className={styles.filter__container}>
      ...
      <section className={styles.filter__type}>
        ...
        />
        <p>
          ${filters.precio[0]} - ${filters.precio[1]}
        </p>
      </section>
